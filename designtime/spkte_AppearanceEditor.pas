...
//**   FMX.Messages, SysUtils, Variants, Classes, FMX.Graphics, FMX.Controls, FMX.Forms,
//**   FMX.Dialogs, FMX.ExtCtrls, FMX.StdCtrls,
  ...
  spkt_Appearance, FMX.ScrollBox, FMX.Controls.Presentation;
...
begin
cbLinkTab.IsChecked:=Value;
cbLinkPane.IsChecked:=Value;
cbLinkItem.IsChecked:=Value;
...
with AAppearance do
     ...
     with Tab do
          ...
          SetPanelColor(pTabHeaderFontColor, TabHeaderColor);
          end;
...
//          SetPanelColor(pPaneCaptionFontColor, CaptionColor);
          end;
